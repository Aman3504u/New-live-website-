...
for the admin panel. An optional tiny FastAPI service in
[`backend/`](./backend) keeps an **anonymous** prank counter alongside
it — it stores a single integer and a timestamp, never the form values.
